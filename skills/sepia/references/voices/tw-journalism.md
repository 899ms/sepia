...
| A dated block for a non-corrective follow-up instead of edits to the body; a correction revises the body with a dated note | C; `journalism.md` rule 6 | check 7 | Only new facts |
...
> 3 月 4 日 14:02，重試佇列開始把失敗的請求重送。14:41 才找到原因。中間的 39 分鐘，急診那邊怎麼過的？
>
