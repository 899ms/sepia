...
| Titles and names: on first mention the full title precedes the full name (行政院長某某某) | Consensus (guides §五 8) | Fix a title placed after the name in the English order (某某某行政院長) on a Taiwanese venue |
