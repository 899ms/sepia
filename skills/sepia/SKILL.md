...
| Leave slack | Ordinary sentences, an underdeveloped thought, a plain paragraph. Do not sand every surface. Measured once: when GPT-3.5, Llama 3 70B and Gemini Pro rewrote 1,000 human Reddit stories and 1,000 arXiv abstracts under neutral prompts, the spread of a writing-complexity score across texts shrank by 21–50% (Sourati et al. 2026, ledger `SOURATI-2026`); a polish that removes the slack is the machine trace this row guards against. |
